...
assert adminPassword != null : "ACTION_JENKINS_ADMIN_USERNAME env variable must be set"
assert adminPassword != null : "ACTION_JENKINS_ADMIN_PASSWORD env variable must be set"
